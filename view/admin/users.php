    ...
    <body class="animsition">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="frmUser" method="post">
                            ...
                            <div>
                                <button type="button" class="btn btn-lg btn-info btn-block btnEditUser">
        ...
        <div class="modal fade" id="deleteUser" tabindex="-1" aria-labelledby="deleteUserLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteUserLabel">Do you really want to delete this user?</h5>
                        <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12 text-center">
                                ...
                                <button type="button" class="btn btn-danger btnDeleteUser">Delete</button>
                            </div>
                        </div>
                    </div>
                </div>
